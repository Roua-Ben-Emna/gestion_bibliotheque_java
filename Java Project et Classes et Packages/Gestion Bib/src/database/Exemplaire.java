...
stamt.executeUpdate(sql);
 	JOptionPane.showMessageDialog(null,"exemplaires ajoutés avec succès","Succès",JOptionPane.PLAIN_MESSAGE,icon);
}catch(Exception e1)
{{
	JOptionPane.showMessageDialog(null,"Erreur lors de l'ajout","Erreur",JOptionPane.PLAIN_MESSAGE,icon1);}
}
}
...
if (x>y)
{
JOptionPane.showMessageDialog(null,"Suppression de ce nombre d'exemplaires impossible","Echec",JOptionPane.PLAIN_MESSAGE,icon1);	
}
else	
...
JOptionPane.showMessageDialog(null,"exemplaires supprimées avec succès","Succès",JOptionPane.PLAIN_MESSAGE,icon);}}
catch(Exception e1)
{System.out.println(e1);
JOptionPane.showMessageDialog(null,"Erreur lors de la suppression","Erreur",JOptionPane.PLAIN_MESSAGE,icon1);}	
	}
}	
